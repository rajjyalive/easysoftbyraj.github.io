		...
		<div class=" col col-md-12 col-lg-8 m-auto m-5"> 
			 ...
			 <div class="card p-5 bg-ess">
			 	<div class="card-header text-center">
			 		<h1 class=" p-4 "><u>ADMISSION SUCCESSFUL</u></h1>
			 		<h4 class="text-uppercase">Name : <?php echo $_SESSION['sname']; ?></h4>
			 		<h6>Your Enrollment No is : <?php echo $_SESSION['sid']; ?></h6>
			 	</div>
			 	<div class="card-header text-center">
			 	 <a href="closesession.php" class="btn btn-success m-2">Close</a>
