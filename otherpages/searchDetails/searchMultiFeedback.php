...
if (!isset($_SESSION['staffuser'])) {
       ...
       $fdata1 = "SELECT * FROM `user_feedback` WHERE `enroll_no` = '{$_SESSION['ids']}'";
       $ffire = mysqli_query($conn,$fdata1);
		...
		<div class="row">
			<div class="col col-md-12">
				<table class="table table-bordered" id="tb">
                   ...
                   <tbody>
                   	<?php while ($fres = mysqli_fetch_array($ffire)) { ?>
                     <tr>
                       <td scope="row"><?php echo $fres['enroll_no']; ?></td>
                       <td><?php echo $_SESSION['mulname']; ?></td>
                       <td><?php echo $fres['mobile']; ?></td>
                       <td><?php echo $fres['message']; ?></td>
