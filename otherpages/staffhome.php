	...
	<nav class="navbar navbar-expand-lg bg-warning navbar-dark sticky-top">
 	...
 	<div class="collapse navbar-collapse" id="navbarmenu2">
		<ul class="nav navbar-nav text-center pl-md-5">
			<li class="nav-item">
				<a href="#" class="btn btn-warning text-dark active"><i class="fas fa-home"></i> Home</a>
			</li>
			<li class="nav-item">
	...
	<div class="row">
	   ...
	   <div class="col col-md-12 col-lg-8 ">
			...
			<div class="container-fluid my-5">
				...
				<div class="d-inline-flex text-white w-100 text-center my-3">
					<a href="../admission.php" class="p-2 bg-ess w-100 bg-essyhover">New Admission</a>
					<a href="studentdetails.php" class="p-2 bg-ess mx-1 mx-sm-1 mx-md-4 w-100 bg-essyhover">Student Details</a>
					  
					<a href="updateDetails/updateStudentDetails.php" class="p-2 bg-ess w-100 bg-essyhover">Update Details</a>
				</div>
				<div class="d-inline-flex text-white w-100 text-center my-3">
					<a href="updateDetails/reregistrationpage.php" class="p-2 bg-ess w-100 bg-essyhover">Re-Registration</a>
					<a href="updateDetails/Installmentpage.php" class="p-2 bg-ess mx-1 mx-sm-1 mx-md-4 w-100 bg-essyhover">Installments</a>
					<a href="#NotificationModal" data-toggle="modal" class="p-2 bg-ess w-100 bg-essyhover">Post Notification</a>
					<!-- Modal -->
                   <div class="modal fade" id="NotificationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                     <div class="modal-dialog modal-dialog-centered" role="document">
                       <div class="modal-content">
                         <form action="../backendcodes/notificationPost.php" method="post">
                         <div class="modal-header bg-essy">
                           <h5 class="modal-title" id="exampleModalLongTitle"><u>POST NOTIFICATION</u></h5>
                           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                             <span aria-hidden="true">&times;</span>
                           </button>
                         </div>
                         <div class="modal-body text-ess ">
                               	<div class="form-group text-left">
                               		<label>Date :</label>
                               		<input type="date" class="form-control" name="noti_date">
                               	</div>
                               	<div class="form-group text-left">
                               		<label>Write a Notification :</label>
                               		<input type="text" class="form-control" placeholder="Write here..." name="write_noti">
                               	</div>
                             
                         </div>
                         <div class="modal-footer">
                           <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                           <button type="submit" class="btn bg-essy bg-essyhover" name="post">Post</button>
                         </div>
                         </form>
                       </div>
                     </div>
				...
				<div class="d-inline-flex text-white w-100 text-center my-3">
					<a href="updateDetails/formFilling.php" class="p-2 bg-ess w-100 bg-essyhover">Form Fill-up</a>
					<a href="#" class="p-2 bg-ess mx-1 mx-sm-1 mx-md-4 w-100 bg-essyhover">Post Results</a>
					<a href="#" class="p-2 bg-ess w-100 bg-essyhover">Delete Details</a>
				</div>
