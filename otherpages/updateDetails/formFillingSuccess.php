		...
		<div class=" col col-md-12 col-lg-8 m-auto m-5"> 
			 ...
			 <div class="card p-5 bg-ess">
			 	<div class="card-header text-center">
			 		<h1 class=" p-4 "><u>FORM FILL-UP SUCCESSFUL</u></h1>
			 		<h4>Name :<span class="text-uppercase"> <?php echo $_SESSION['fName']; ?></span></h4>
			 		<h6>Enrollment No : <?php echo $_SESSION['fEnroll']; ?></h6>
			 		<br>
			 		<h6>Fee Paid Successfully :  <?php echo $_SESSION['fFees']; ?> /-</h6>
			 	</div>
			 	<div class="card-header text-center">
			 	 <a href="formFilling.php" class="btn btn-success m-2">Close</a>
