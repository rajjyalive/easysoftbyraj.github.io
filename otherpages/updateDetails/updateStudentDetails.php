			...
			<div class="container my-5">
				<div class="card w-75 m-auto bg-ess">
					...
					<div class="card-header bg-essy">
						<h3 class="text-uppercase text-center"><u>UPDATE STUDENT DETAILS</u></h3>
					</div>
					<div class="card-body">
							
							<div class="form-group">
							    <label>Enrollment No :</label>
								<input type="text" class="form-control" autocomplete="off" placeholder="Enter Enrollment No" name="updateEnroll">
							</div>
													
							<div class="form-group">
						 <label>For Update :</label>
                        <select class="form-control" name="updateSelect">
                          ...
                          <option value="ImageandSign">Image and Sign</option>
					 ...
					 <div class="card-footer">
						 ...
						 <input type="submit" class="form-control btn bg-essy py-2 px-4 bg-essyhover" value="Update" name="updateSubmit">
						    </div>
						 </div>
					 </div>
				    </form>
