		...
		<div class=" col col-md-12 col-lg-8 m-auto m-5"> 
			 ...
			 <div class="card p-5 bg-ess">
			 	<div class="card-header text-center">
			 		<h1 class=" p-4 "><u>RE-REGISTRATION SUCCESSFUL</u></h1>
			 		<h4>Name :<span class="text-uppercase"> <?php echo $_SESSION['reName']; ?></span></h4>
			 		<h6>Enrollment No : <?php echo $_SESSION['reEnroll']; ?></h6>
			 		<br>
			 		<h6>Fee Paid Successfully :  <?php echo $_SESSION['reFees']; ?> /-</h6>
			 	</div>
			 	<div class="card-header text-center">
			 	 <a href="reregistrationpage.php" class="btn btn-success m-2">Close</a>
