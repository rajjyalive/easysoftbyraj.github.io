  <?php 
       ...
       if (!isset($_SESSION['staffuser'])) {
    	...
    	$fEnroll = $_POST['fEnroll'];
    	$fName = $_POST['fName'];
    	$fFees = $_POST['fFees'];

        $fins = "INSERT INTO `form_fillup`(`enroll_no`, `name`, `courses`, `fees`) VALUES ('$fEnroll','$fName','$fSelect','$fFees')";
        mysqli_query($conn,$fins);

    	$_SESSION['fEnroll'] = $fEnroll;
    	$_SESSION['fName'] = $fName;
    	$_SESSION['fFees'] = $fFees;

    	header('location:formFillingSuccess.php');
			...
			<div class="container my-5">
				<div class="card w-75 m-auto bg-ess">
					...
					<div class="card-header bg-essy">
						<h3 class="text-uppercase text-center"><u>Form Fill-up</u></h3>
					</div>
					<div class="card-body">
							<div class="form-group">
						 <label>Courses for :</label>
                        <select class="form-control" name="fSelect">
                          ...
                          <option value="TALLY">TALLY</option>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" autocomplete="off" placeholder="Enter Enrollment No" name="fEnroll">
							</div>
							<div class="form-group">
							    <label>Full Name :</label>
								<input type="text" class="form-control" autocomplete="off" placeholder="Enter Full Name" name="fName">
							</div>
							<div class="form-group">
							       Fees :
								<input type="number" class="form-control" autocomplete="off" placeholder="Fees" name="fFees">
							</div>
					 ...
					 <div class="card-footer">
						 ...
						 <input type="submit" class="form-control btn bg-essy py-2 px-4 bg-essyhover" value="Proceed" name="fSubmit">
						    </div>
						 </div>
					 </div>
				    </form>
