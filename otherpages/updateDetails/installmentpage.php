<?php 
       ...
       if (!isset($_SESSION['staffuser'])) {
    	...
    	$insSelect = $_POST['insSelect'];
    	$insEnroll = $_POST['insEnroll'];
    	$insName = $_POST['insName'];
    	$insFees = $_POST['insFees'];
    	$ins = "INSERT INTO `installment`(`enroll_no`, `name`, `courses`, `fees`) VALUES ('$insEnroll','$insName','$insSelect','$insFees')";
    	mysqli_query($conn,$ins);

    	$_SESSION['insEnroll'] = $insEnroll;
    	$_SESSION['insName'] = $insName;
    	$_SESSION['insFees'] = $insFees;
    	header('location:installmentSuccess.php');
    }
			...
			<div class="container my-5">
				<div class="card w-75 m-auto bg-ess">
					...
					<div class="card-header bg-essy">
						<h3 class="text-uppercase text-center"><u>PAY YOUR INSTALLMENT</u></h3>
					</div>
					<div class="card-body">
							<div class="form-group">
						 <label>Courses for :</label>
                        <select class="form-control" name="insSelect">
                          ...
                          <option value="TALLY">TALLY</option>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" autocomplete="off" placeholder="Enter Enrollment No" name="insEnroll">
							</div>
							<div class="form-group">
							    <label>Full Name :</label>
								<input type="text" class="form-control" autocomplete="off" placeholder="Enter Full Name" name="insName">
							</div>
							<div class="form-group">
							       Installment Fees :
								<input type="number" class="form-control" autocomplete="off" placeholder="Fees" name="insFees">
							</div>
					 ...
					 <div class="card-footer">
						 ...
						 <input type="submit" class="form-control btn bg-essy py-2 px-4 bg-essyhover" value="Proceed" name="insSubmit">
						    </div>
						 </div>
					 </div>
				    </form>
